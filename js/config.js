...
const SVG_ICONS = {
  ...
  instagram: `<svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="5" fill="#E1306C"/><circle cx="12" cy="12" r="4.25" fill="none" stroke="#FFFFFF" stroke-width="2"/><circle cx="17.25" cy="6.75" r="1.25" fill="#FFFFFF"/></svg>`,
