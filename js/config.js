...
const SVG_ICONS = {
  ...
  instagram: `<svg viewBox="0 0 24 24" aria-hidden="true"><defs><linearGradient id="instagramGradient" x1="2" y1="22" x2="22" y2="2" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#FFDD55"/><stop offset=".28" stop-color="#FF543E"/><stop offset=".55" stop-color="#C837AB"/><stop offset="1" stop-color="#405DE6"/></linearGradient></defs><rect x="3" y="3" width="18" height="18" rx="5" fill="url(#instagramGradient)"/><circle cx="12" cy="12" r="4.25" fill="none" stroke="#fff" stroke-width="2"/><circle cx="17.25" cy="6.75" r="1.25" fill="#fff"/></svg>`,
